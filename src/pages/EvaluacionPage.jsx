...
const CALIF_UI = {
  APTO: { cls: 'apto', icon: CheckCircle2, color: '#10B981' },
  REVISAR: { cls: 'revisar', icon: AlertTriangle, color: '#F59E0B' },
  NO_PROCEDE: { cls: 'rechazo', icon: XCircle, color: '#EF4444' },
}
        ...
        <>
          {res.en_lista_negra && (
            <div className="cm-result rechazo" style={{ marginTop: 18 }}>
              <span className="cm-result-ico" style={{ background: 'var(--ef-error-light)', color: 'var(--ef-error)' }}><Ban size={28} /></span>
              <div>
          ...
          <div className={`cm-result ${res.en_lista_negra ? 'rechazo' : res.dias_mayor_mora > 0 ? 'revisar' : 'apto'}`} style={{ marginTop: 16 }}>
            <span className="cm-result-ico" style={{ background: 'var(--ef-secondary-light)', color: 'var(--ef-secondary)' }}><Building2 size={28} /></span>
            <div style={{ flex: 1 }}>
