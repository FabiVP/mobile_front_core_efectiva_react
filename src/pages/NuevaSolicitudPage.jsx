    ...
    <>
      ...
      <form onSubmit={onSubmit}>
        ...
        <Card title="Condiciones del crédito" icon={Coins} style={{ marginTop: 16 }}>
          ...
          {cuotaEstimada > 0 && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'var(--ef-success-light)', border: '1px solid #A7F3D0', borderRadius: 10, padding: '12px 16px' }}>
              <Coins size={20} color="#047857" />
              <span style={{ color: '#047857', fontWeight: 600 }}>Cuota mensual estimada:</span>
              <span style={{ marginLeft: 'auto', fontSize: 18, fontWeight: 800, color: 'var(--ef-success)' }}>
