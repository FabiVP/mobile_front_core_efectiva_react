        ...
        <>
          <div className="cm-kpis">
            <div className="cm-kpi">
              <span className="cm-kpi-ico" style={{ background: 'var(--ef-primary-light)', color: 'var(--ef-primary)' }}><FileCheck2 size={24} /></span>
            ...
            <div className="cm-kpi" style={{ borderLeftColor: 'var(--ef-success)' }}>
              <span className="cm-kpi-ico" style={{ background: 'var(--ef-success-light)', color: 'var(--ef-success)' }}><Trophy size={24} /></span>
              <div>
            ...
            <div className="cm-kpi" style={{ borderLeftColor: 'var(--ef-warning)' }}>
              <span className="cm-kpi-ico" style={{ background: 'var(--ef-warning-light)', color: 'var(--ef-warning)' }}><Wallet size={24} /></span>
            ...
            <div className="cm-kpi" style={{ borderLeftColor: 'var(--ef-secondary)' }}>
              <span className="cm-kpi-ico" style={{ background: 'var(--ef-secondary-light)', color: 'var(--ef-secondary)' }}><Users size={24} /></span>
