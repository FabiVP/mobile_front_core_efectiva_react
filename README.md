# Core Financiero — Portal del Personal (Financiera Efectiva)

Front-end en **React + Vite** para la fuerza de ventas / asesores de Financiera Efectiva.

`mobile_backend_core_andino_fastapi` (puerto **8003**).

> Sistema interno · uso exclusivo del personal. El portal del **cliente**
> (Banca por Internet) es un proyecto aparte.
...
## Requisitos
- Backend `mobile_backend_core_andino_fastapi` corriendo en `http://localhost:8003`
...
## Identidad de marca
  Paleta de marca Financiera Efectiva (rojo `#e2132b`, magenta, naranja, amarillo, turquesa,
...
src/
  ...
  index.css                tema Financiera Efectiva + estilos del portal
